...
def largest_product_of_four(x_starting_point, y_starting_point)
  max = 0  
  x_starting_point.upto(GRID.size - 4) do |x|
    y_starting_point.upto(GRID.size - 4) do |y|
      product = yield(x, y)
...
require 'test/unit'
class LargestProductInGridTest < Test::Unit::TestCase

  def test_largest_product_better
    assert_equal 70600674, 
    [
     largest_product_of_four(0,0){|x,y| GRID[x][y].to_i * GRID[x][y+1].to_i * GRID[x][y+2].to_i * GRID[x][y+3].to_i},  # vertically
     largest_product_of_four(0,0){|x,y| GRID[x][y].to_i * GRID[x+1][y].to_i * GRID[x+2][y].to_i * GRID[x+3][y].to_i},  # horizontally
     largest_product_of_four(3, 0){|x,y| GRID[x][y].to_i * GRID[x][y+1].to_i * GRID[x][y+2].to_i * GRID[x][y+3].to_i}, # diagional down
     largest_product_of_four(0,0){|x,y| GRID[x][y].to_i * GRID[x-1][y+1].to_i * GRID[x-2][y+2].to_i * GRID[x-3][y+3].to_i}].max #diagional up
  end
end
